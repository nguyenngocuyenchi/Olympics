...
<body>
    ...
    <?php $__currentLoopData = $spectateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spectateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="container-fluid">
        <h3>Spectateur: <?php echo e($spectateur->id); ?></h3>
        ...
        <ul>
        <?php $__currentLoopData = $total_billets[$spectateur->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $billet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="col-3">
        <a href="<?php echo e(url('/billetterie/panier')); ?>">Valider <i class="fa fa-arrow-right"></i></a>
        </div>
        <div class="col-6"></div>
        </div>
    </div>
