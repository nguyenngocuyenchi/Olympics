...
<?php $__env->startSection('nav'); ?>
    <a class="nav-link" href="<?php echo e(route('programmer')); ?>">Programmer une compétition</a>
    <a class="nav-link" href="<?php echo e(route('gerer')); ?>">Gérer les compétitions</a>
                    ...
                    <?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__currentLoopData = $sport->competition; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $competition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                ...
                                <form action="<?php echo e(route('supprimer', $competition->id)); ?>" method="POST" style="display: inline-block;">
                                    <?php echo csrf_field(); ?>
                                ...
                                <a href="<?php echo e(route('modifier', $competition->id)); ?>" class="btn btn-warning">
...
<?php echo $__env->make('application', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\tamil\www\jos\resources\views/gerer.blade.php ENDPATH**/ ?>