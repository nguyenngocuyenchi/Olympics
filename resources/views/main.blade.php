...
<head>
    ...
    <style>
        ...
        .bg_main {
            ...
            width: 100%;
            height: 100%;
            background: url("{{ asset('photo/main/background.png') }}");
    ...
    .bg_calendrier {
            ...
            width: 100%;
            height: 50%;
            background: url("{{ asset('photo/main/calender.png') }}");
            background-size: cover;
            display: flex;
            background-position: center;
            margin-top : 4rem;
...
<body>
    <div class="bg_main" >
        ...
        <img class="mascot" src="{{ asset('photo/main/mascot.png') }}" alt="mascot">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <ul class="navbar-nav">
                <li class="nav-item col me-md-5">
                    <div class="dropdown">
                        ...
                        <li><a class="dropdown-item" href="{{url('/main')}}">Accueil</a></li>
                        <li><a class="dropdown-item" href="{{url('/calendrier')}}">Calendrier</a></li>
                        <li><a class="dropdown-item" href="{{url('/sport')}}">Les Jeux</a></li>
                        <li><a class="dropdown-item" href="{{url('/boutique')}}">Boutique</a></li>
                        <li><a class="dropdown-item" href="{{url('/billetterie')}}">Billetterie</a></li>
                ...
                <li class="nav-item col mx-md-5"><a class="nav-link text-white" href="{{url('/calendrier')}}"><b>Calendrier</b></a></li>
                <li class="nav-item col mx-md-5"><a class="nav-link text-white" href="{{url('/billetterie')}}"><b>Billetterie</b></a></li>
     ...
     <span class="input-group-append">
         <button class="btn btn-outline-secondary rounded-pill border-0 ml-n5" type="button">
            ...
            <img class="logo" src="{{ asset('photo/main/logo.png') }}" alt="logo">
        </div>
    </nav>
</div>
...
<div class="container">
  <div class="row">
    <div class="col">
    <img class="bg_sport"  src="{{ asset('photo/main/running.png') }}" alt="running">
...
<div class="container">
  <div class="row">
    ...
    <form action=" {{url('/billetterie')}}" method="GET">
    <button class="btn1">Accéder à la vente <i class="fa fa-arrow-right"></i></button>    
    </form>
    </div>

    <div class="col">
    <img class="bg_sport" src="{{ asset('photo/main/ticket.png') }}" alt="ticket">
    </div>
...
<a class="nav-link text-white text-center" href="{{url('/calendrier')}}"><b>Calendrier</b></a>
    </div>
